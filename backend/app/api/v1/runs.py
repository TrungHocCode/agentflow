...
async def start_run(
    ...
    """
    run_doc = await RunService.create_run(
        flow_id=req.flow_id,
...
async def list_runs(
    ...
    """
    return await RunService.list_runs(flow_id=flow_id, limit=limit)
...
async def approve_run(
    ...
    """
    run_doc = await RunService.approve_run(
        run_id=run_id,
...
async def stream_run(run_id: str):
    ...
    return StreamingResponse(
        RunService.stream_run_events(run_id),
